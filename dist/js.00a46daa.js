...
var currentCard = 0;
var elementParcours = document.getElementsByClassName('text');
var currentText = 0;

function nextSlide() {
  // je cache l'image current
  images[currentCard].className = 'card';
  elementParcours[currentText].className = 'text'; // je passe à la prochaine image

  currentCard = (currentCard + 1) % images.length;
  currentText = (currentText + 1) % elementParcours.length; // j'ajoute la classe current à ma nouvelle image pour la rendre visible
